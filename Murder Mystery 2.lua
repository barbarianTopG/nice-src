	...
	if state then
		task.spawn(function()
			while coinESPEnabled do
				local success, err = pcall(function()
					for _, container in ipairs(game:GetService("Workspace"):GetDescendants()) do
	...
	if state then
		task.spawn(function()
			while loopTPMurder do
				...
				if murder and murder.Character and murder.Character:FindFirstChild("HumanoidRootPart") then
					local hrp = murder.Character.HumanoidRootPart;
					local myChar = game:GetService("Players").LocalPlayer.Character or game:GetService("Players").LocalPlayer.CharacterAdded:Wait()
	...
	if state then
		task.spawn(function()
			while loopTPStab do
				...
				for _, player in ipairs(game:GetService("Players"):GetPlayers()) do
					if player ~= game:GetService("Players").LocalPlayer and player.Character and player.Character:FindFirstChild("HumanoidRootPart") and player.Character:FindFirstChildOfClass("Humanoid").Health > 0 then
						local char = game:GetService("Players").LocalPlayer.Character or game:GetService("Players").LocalPlayer.CharacterAdded:Wait()
						local hrp = char:WaitForChild("HumanoidRootPart")
				...
				if closestPlayer then
					...
					local knife = game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Knife") or char:FindFirstChild("Knife")
					if knife then
...
FlyToggle:OnChanged(function()
	...
	if FlyEnabled then
		...
		FlyBodyVelocity.MaxForce = Vector3.new(1, 1, 1)
		FlyBodyVelocity.Velocity = Vector3.new(0, 0, 0)
		FlyBodyVelocity.Parent = hrp;
		FlyBodyGyro = Instance.new("BodyGyro")
		FlyBodyGyro.MaxTorque = Vector3.new(1, 1, 1)
